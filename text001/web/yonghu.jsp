...
<script>
    var $table = $('#table');
    var servlet_url = "/yonghu";
    var servlet_jue = "/manage/juese"
    $("#input1").val("ssss");
    $(function() {
        ...
        $table.bootstrapTable({
            ...
            columns: [
                ...
                {field: 'loginip', title: 'ip',  halign: 'center',align:"center"},
...
//            '<a class="edit ml10" href="javascript:void(0)" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-edit"></i></a>　',
    ...
    window.actionEvents = {
        'click .like': function (e, value, row, index) {
            $.confirm({
                content:'url:/permissionjue/index.jsp',
                title:'用户角色',
                buttons:{
                    confirm:{
                        text:"确定",
                        action:function () {
                            ...
                            for(var i=0;i<nodes.length;i++){
                                s+= nodes[i].id+",";
                                $.post(servlet_jue+'?m=userjue',{"id":row.id,"nodes":s},function(txt){
                                    $.alert(txt.message)
                                },"JSON")
                            }
                        }
                ...
                confirm: {
                    ...
                    action: function () {
                        ...
                        if(t==""){
                            ...
                            $.get(servlet_url+"?m=add",{"username":t,"password":desc},function(txt) {
