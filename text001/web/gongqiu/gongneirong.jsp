...
<div style="width: 80%;margin: 0 auto">
    ...
    <br/>
    <br/>
    <div id="liu" style="margin-top: 20px;float: left;">
...
<script>
    $(document).ready(function () {
        $("#tijiao").click(function () {
            ...
            $.post("/manage/login/liuyan?m=gong",{"xid":xid,"name":name,"dian":dian,"shou":shou,"you":you,"content":content},function (json) {
                alert(json);
            },'json');
        })
    })
