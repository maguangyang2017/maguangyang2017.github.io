...
<div>
            ...
            <div class="col-lg-7" style="height: 105px; position: relative;">
                ...
                <div class="_nav">
                    <ul class="nav nav-tabs nav_index" role="tablist" style="clear: both">
                        ...
                        <li role="presentation" class="active"><a href="/webFronts/page/SDEdit?m=indexChanpin" >产品库</a></li>
    ...
    <div class="_content" style="clear: both">
        ...
        <div class="_weizhi" style="width: 100%; height: auto; overflow: hidden">
            <p id="_dangqian">您的位置》<a href="/b2b/index.jsp">志趣</a>》<a href="/webFronts/page/SDEdit?m=indexChanpin" >产品库</a></p>
            <div class="hangye">
...
//        /webFronts/supDem/message?m=demAll
        $("#iframepage").attr('src',"/webFronts/supDem/message?m=b2b&sdType=2&fid="+fid);
...
//        /webFronts/supDem/message?m=demAll
        $("#iframepage").attr('src',"/webFronts/supDem/message?m=b2b&sdType=2&fid="+fid+"&zid="+zid);
        $("#types").html("");
