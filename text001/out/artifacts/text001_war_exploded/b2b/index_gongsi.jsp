...
<div>
            ...
            <div class="col-lg-7" style="height: 105px; position: relative;">
                <div style="float: right">
                    ...
                    <div class="btn-group" role="group" id="user_">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/webFronts/aboutMe.jsp">个人中心</a></li>
                            <script>
                                //退出登录
                                function logon() {
                ...
                <div class="_nav">
                    <ul class="nav nav-tabs nav_index" role="tablist" style="clear: both">
                        ...
                        <li role="presentation" class="active"><a href="/webFronts/page/SDEdit?m=indexGongsi">公司库</a></li>
                    </ul>
                </div>
    ...
    <div class="_content" style="clear: both">
        ...
        <div class="_weizhi" style="width: 100%; height: auto; overflow: hidden">
            <p id="_dangqian">您的位置》<a href="/b2b/index.jsp">志趣</a>》<a href="/webFronts/page/SDEdit?m=indexGongsi">公司库</a></p>
            <div class="hangye">
        ...
        <div class="tab-content" style="clear: both; width: 650px; height: auto; overflow: hidden; float: left">
            <iframe src="/index/gongying?m=getAllInfo&page=0" marginheight="0" marginwidth="0" frameborder="0" scrolling="no" width="100%" id="iframepage" name="iframepage" onLoad="iFrameHeight()" ></iframe>
...
//        /webFronts/supDem/message?m=demAll
        $("#iframepage").attr('src',"/webFronts/supDem/message?m=b2b&sdType=3&fid="+fid);
...
//        /webFronts/supDem/message?m=demAll
        $("#iframepage").attr('src',"/webFronts/supDem/message?m=b2b&sdType=3&fid="+fid+"&zid="+zid);
        $("#types").html("");
