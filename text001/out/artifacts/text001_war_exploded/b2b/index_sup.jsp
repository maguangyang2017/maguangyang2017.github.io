...
<div>
            ...
            <div class="col-lg-7" style="height: 105px; position: relative;">
                ...
                <div class="_nav">
                    <ul class="nav nav-tabs nav_index" role="tablist" style="clear: both">
                        ...
                        <li role="presentation"><a href="/webFronts/page/SDEdit?m=indexDem" >求购信息</a></li>
                        <li role="presentation" class="active"><a href="/webFronts/page/SDEdit?m=indexSup" >供应信息</a></li>
    ...
    <div class="_content" style="clear: both">
        ...
        <div class="_weizhi" style="width: 100%; height: auto; overflow: hidden">
            <p id="_dangqian">您的位置ssss》<a href="/b2b/index.jsp">志趣</a>》<a href="/webFronts/page/SDEdit?m=indexSup" >供应信息</a></p>
            <div class="hangye">
        ...
        <div class="tab-content" style="clear: both; width: 650px; height: auto; overflow: hidden; float: left">
            <iframe src="/index/gongying?m=getAllInfo&page=1" marginheight="0" marginwidth="0" frameborder="0" scrolling="no" width="100%"id="iframepage" name="iframepage" onLoad="iFrameHeight()" ></iframe>
...
//        alert(zzid);
        if(ffid=="null"){
            //$("#iframepage").attr('src',"/index/gongying?m=index");
        }else if(zzid=="null"){
            xuanze(ffid,fttitle);
        }else{
//            xuanze(ffid,ttitle);
            xuanze3(ffid,zzid,fttitle,zttitle);
        }
    });

    function xuanze(fid,title) {
//        /webFronts/supDem/message?m=demAll
        $("#iframepage").attr('src',"/index/gongying?m=getbyid&id="+fid);
...
//        /webFronts/supDem/message?m=demAll
        $("#iframepage").attr('src',"/index/gongying?m=getbyid&id="+fid+"&zid="+zid);
        $("#types").html("");
        $("#_dangqian").html(weizhi2+"》<a href=\"javascript:xuanze("+fid+","+zid+",'"+title+"');\">"+title+"</a>");
    }
    function xuanze3(fid,zid,fTitle,zTitle) {
//        /webFronts/supDem/message?m=demAll
        $("#iframepage").attr('src',"/index/gongying?m=getbyid&id="+fid);
        $.post('/webFronts/sup_index',{"pid":fid},function (json) {
            var htm = "";
...
//            alert(htm);
            $("#types").html(htm);
            $("#_dangqian").html(weizhi1+"》<a href=\"javascript:xuanze("+fid+",'"+fTitle+"');\">"+fTitle+"</a>");
            weizhi2 = $("#_dangqian").html();
            xuanze2(fid,zid,zTitle);
        },'json');
    }
